...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ScoreBoard-Demo.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ford-wang/ScoreBoard-Demo'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ford-wang' => 'Enjoy coding' }
  s.source           = { :git => 'https://github.com/ford-wang/ScoreBoard-Demo.git', :tag => s.version.to_s }
